...
import sys
import os
# Добавляем родительскую директорию в путь для импорта модулей из src
...
class CTEBuilderDialog(QDialog):
    ...
    def _open_select_builder(self, text_edit: QTextEdit):
        ...
        import select_builder_dialog
        SelectBuilderDialog = select_builder_dialog.SelectBuilderDialog
