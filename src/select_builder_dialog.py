...
class SelectBuilderDialog(QDialog):
    def __init__(self, parent=None, schema="app"):
        ...
        self.setStyleSheet("""
            ...
            QLabel { color: white; font-size: 13px; padding: 8px; }
            ...
            QLineEdit, QComboBox { padding: 10px; min-height: 28px; }
            QTextEdit { padding: 10px; font-size: 13px; font-family: 'Courier New', monospace; }
            QPushButton {
                background-color: rgba(2,65,118,255); color: rgba(255,255,255,200);
                border-radius: 5px; padding: 10px 12px; min-height: 32px; min-width: 100px; font-size: 13px;
            }
